...
| 9 | [Keep a register](09-keep-a-register.md) | One file that says what your agent is, with an id that every run record carries, and four tests that fail when the file and the code disagree. | 1 hour |
| 10 | [What you built](10-what-you-built.md) | No new code: the first agent beside the last, the five boxes as things you built, and how to build the agent from your own sentence. | 20 minutes |
